...
* Method: cellValue
********************************************************************/
const Real &LocalTransAdmin::cellValue( const NeighborPosition &pos, const string PortName )
{
...
********************************************************************/
const Real &LocalTransAdmin::portValue( const string name )
{
