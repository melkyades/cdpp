...
class ActiveNode : public SimulationObj {

public:
  ActiveNode(int identifier , char *myName , int *dest , int noOfNeighbors);
  ...
  ~ActiveNode(){};
   ...
   void callEnv2(SmartPacket *recvPacket);

   void Tgen(SmartPacket *recvPacket);
